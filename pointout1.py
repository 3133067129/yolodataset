...
def move_mouse_ctypes(x, y, rand_offset=True):
    """用ctypes调用SetCursorPos实现鼠标移动"""
    if rand_offset:
        ...
        try:
            ...
            for data in results.boxes.data.tolist():
                ...
                if current_time - self.last_move_time > self.move_delay * random.uniform(0.8, 1.2):
                    ...
                    move_mouse_ctypes(global_center_x, global_center_y)  # 这里改用新函数
...
# 其余代码保持不变，包括check_admin_permission、load_model、SettingsWindow等
